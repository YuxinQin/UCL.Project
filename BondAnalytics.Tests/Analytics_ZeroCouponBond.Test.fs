module Analytics_ZeroCouponBond
...
[<TestFixture>]
type Analytics_ZeroCouponBond() = class
  
    let bond = {
        BondType = Domain.BondTypes.ZeroCouponBond
        Maturity = date 2012 12 31
        Coupon = 1.3
        LastInterestDate = date 2005 03 20
    ...
    member t.bond_getAccrued() =
        getAccrued |> should equal 0.092602739726027394 |> ignore
